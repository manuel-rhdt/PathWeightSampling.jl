...
@time "mutual_information (HybridJumpSystem, 1000 samples)" mi = PWS.mutual_information(system, PWS.SMCEstimate(128), num_samples=1000, threads=true, progress=false)
